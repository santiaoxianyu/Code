...
//	enableGameRotationVector(400);
//	enableAccelerometer(500);
//	enableLinearAccelerometer(400);
//	enableGyro(1000);
...
//	enableStabilityClassifier(100);
	...
	enableGyro(200);                // 增加陀螺仪的采样率以提高精度
	enableMagnetometer(50);         // 降低磁力计的采样率以节省功耗
	enableStepCounter(10);          // 降低步数计数器的采样率
	enableStabilityClassifier(50);  // 降低稳定性分类器的采样率
	// 开始校准（可选）
//	calibrateAccelerometer();
//	calibrateGyro();
//	calibrateMagnetometer();
//	calibratePlanarAccelerometer();
	calibrateAll();//全部校准
