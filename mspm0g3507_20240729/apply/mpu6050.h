...
#define MPU_SDA_IN()                 DL_GPIO_initDigitalInput(MYIIC_MYSDA_IOMUX)
#define MPU_IIC_SCL(x)      ( (x) ? (DL_GPIO_setPins(MYIIC_MYSCL_PORT,MYIIC_MYSCL_PIN)) : (DL_GPIO_clearPins(MYIIC_MYSCL_PORT,MYIIC_MYSCL_PIN)) )
#define MPU_IIC_SDA(x)      ( (x) ? (DL_GPIO_setPins(MYIIC_MYSDA_PORT,MYIIC_MYSDA_PIN)) : (DL_GPIO_clearPins(MYIIC_MYSDA_PORT,MYIIC_MYSDA_PIN)) )
#define MPU_READ_SDA()        (((DL_GPIO_readPins(MYIIC_MYSDA_PORT,MYIIC_MYSDA_PIN) & MYIIC_MYSDA_PIN ) > 0 ) ? 1 : 0 )
